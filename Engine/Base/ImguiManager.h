...
namespace IFE
{
	...
	public:
		...
		void ComponentGUI(const std::string& name, const std::function<void(void)>& guiFunc, const std::function<void(void)>& deleteFunc);
		...
		void TextMatrixGUI(const std::string& text,const Matrix& mat);
		...
		void TextMatrixGUI(const Matrix& mat);
